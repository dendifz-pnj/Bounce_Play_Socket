...
public final class ShapeUtils {
   ...
   public final Object sizeshape() {
      ...
      return this.tipeShape == 1 ? new Double(this.posX, this.posY, (double)this.lebar, (double)this.tinggi) : new java.awt.geom.Rectangle2D.Double(this.posX, this.posY, (double)this.lebar, (double)this.tinggi);
   }
